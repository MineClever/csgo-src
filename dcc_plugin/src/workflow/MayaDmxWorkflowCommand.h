...
private:
    ...
    static constexpr const char *kTranslateXFlag = "-tx";
    static constexpr const char *kTranslateXLongFlag = "-translateX";
    static constexpr const char *kTranslateYFlag = "-ty";
    static constexpr const char *kTranslateYLongFlag = "-translateY";
    static constexpr const char *kTranslateZFlag = "-tz";
    static constexpr const char *kTranslateZLongFlag = "-translateZ";
    static constexpr const char *kRotateXFlag = "-rx";
    static constexpr const char *kRotateXLongFlag = "-rotateX";
    static constexpr const char *kRotateYFlag = "-ry";
    static constexpr const char *kRotateYLongFlag = "-rotateY";
    static constexpr const char *kRotateZFlag = "-rz";
    static constexpr const char *kRotateZLongFlag = "-rotateZ";
    static constexpr const char *kScaleXFlag = "-sx";
    static constexpr const char *kScaleXLongFlag = "-scaleX";
    static constexpr const char *kScaleYFlag = "-sy";
    static constexpr const char *kScaleYLongFlag = "-scaleY";
    static constexpr const char *kScaleZFlag = "-sz";
    static constexpr const char *kScaleZLongFlag = "-scaleZ";
