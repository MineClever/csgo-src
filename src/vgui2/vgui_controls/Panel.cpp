...
// Purpose: 
//-----------------------------------------------------------------------------
bool Panel::IsFullyVisible()
{
	return ipanel()->IsFullyVisible(GetVPanel());
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void Panel::OnUnserialized( CDmxElement *pElement )
{
	ipanel()->OnUnserialized(GetVPanel(), pElement);
	...
	int x, y;
	GetPos(x, y);
	// scale the x,y up to our screen coords
	if ( IsProportional() )
	{
	...
	int wide, tall;
	GetSize( wide, tall );
	// scale the wide and tall up to our screen co-ords
	if ( IsProportional() )
	{
